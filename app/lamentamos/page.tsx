...
function HoneycombBackground() {
  return (
    <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <pattern id="honeycomb-lamentamos" x="0" y="0" width="56" height="100" patternUnits="userSpaceOnUse">
          <path d="M28 0L56 16.5v33L28 66 0 49.5v-33L28 0z" fill="none" stroke="#A6777F" strokeWidth="1.5" />
          <path d="M28 100L56 83.5v-33L28 34 0 50.5v33L28 100z" fill="none" stroke="#A6777F" strokeWidth="1.5" />
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#honeycomb-lamentamos)" />
    </svg>
  );
}
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center px-6 py-12 bg-[#EDE2D2] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-lg">
        <div className="bg-white border border-[#A6777F]/10 rounded-2xl shadow-sm overflow-hidden">
          {/* Top accent bar */}
          <div className="h-1.5 w-full bg-gradient-to-r from-[#D4AF37] via-[#A6777F] to-[#6A704D]" />
          ...
          <div className="px-8 py-10 md:px-12 md:py-14 text-center">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative flex items-center justify-center">
                <svg width="96" height="110" viewBox="0 0 96 110" className="absolute opacity-[0.08]">
                  <path d="M48 0L93.11 26v58L48 110 2.89 84V26L48 0z" fill="#A6777F" />
                </svg>
                <div className="relative z-10 w-20 h-20 rounded-full bg-gradient-to-br from-[#A6777F]/15 to-[#A6777F]/5 flex items-center justify-center ring-2 ring-[#A6777F]/20 ring-offset-2 ring-offset-white">
                  <Heart className="text-[#A6777F]" size={40} strokeWidth={1.5} />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-3 mb-6 opacity-40">
              <div className="h-px w-10 bg-[#A6777F]" />
            ...
            <p className="text-[#8C7B70] text-lg mb-8 leading-relaxed">
              Entendemos que a veces no se puede. De todos modos, te agradecemos que nos lo hayas hecho saber.
            </p>
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-[#A6777F] text-white hover:bg-[#8B5E66] active:scale-[0.98] transition-all shadow-sm"
            >
              <ArrowLeft size={16} />
              Volver al inicio
            </Link>
        ...
        <div className="flex justify-center mt-3 opacity-[0.06] pointer-events-none">
          <svg width="120" height="24" viewBox="0 0 120 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M20 6L40 0l20 10 20-10 20 10v10l-20 10-20-10-20 10-20-10V6z" fill="#A6777F" />
          </svg>
        </div>
      </div>
    </main>
